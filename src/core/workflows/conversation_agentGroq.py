"""
Production version of the conversation agent using Groq API
"""
...
from src.core.workflows.ticket_classifierGroq import TicketClassifier
...
class ProductionConversationAgent:
    ...
    def handle_customer_message(self, 
        ...
        """
        Handle customer message with production memory system using Groq
        """
        ...
        try:
            ...
            conversation_history = self.memory.get_conversation_history(conversation_id, limit=10)
            ...
            # Step 4: Generate contextual response using Groq
    ...
    def _generate_contextual_response(self, 
        ...
        """Generate response using full production context with Groq"""
        ...
        system_prompt = f"""You are a professional SaaS support agent with access to conversation history and knowledge base.
        ...
        - If escalation is required, explain what happens next clearly
        ...
        - If technical issues are involved, provide step-by-step troubleshooting"""
        
        # Build messages for Groq API
        messages = [{"role": "system", "content": system_prompt}]
        
        # Add recent conversation history (last 4 exchanges to stay within context limits)
        ...
        try:
            ...
            # Fallback response
            if classification.requires_human_escalation:
                return "I understand this is a critical issue. I'm escalating your case to our technical team who will contact you within the next hour with a solution."
            else:
                return "I'm here to help with your request. Could you provide a bit more detail so I can assist you better?"
    ...
    def get_customer_insights(self, customer_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_resolution_time": self._calculate_avg_resolution_time(customer_history)
        }
    ...
    def _calculate_avg_resolution_time(self, conversations: List[Dict]) -> float:
        """Calculate average time to resolution in minutes"""
        resolved_convs = [conv for conv in conversations if conv.get('resolved_at')]
        ...
        return total_time / len(resolved_convs)

# Factory function for easy instantiation
def create_production_agent(api_key: str = None) -> ProductionConversationAgent:
    """Create production agent with Groq API"""
    import os
    api_key = api_key or os.getenv("GROQ_API_KEY")
    return ProductionConversationAgent(api_key=api_key)